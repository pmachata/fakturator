...
\date{\today }
\xdef\invoicenum{###{ID}###}
\xdef\companyname{Blátivé děti, z.s.}
\xdef\companyaddress{Brdlíkova 193/13, Praha, 150 00}
\xdef\companytel{XX\,XX\,XX\,XX\,XX}
\xdef\companyemail{blativedeti@gmail.com}
...
\RequirePackage[pdfencoding=unicode, bookmarks=false, colorlinks=false,
                pdfborder={0 0 0}]{hyperref}
\AtBeginDocument{
   \hypersetup{
     pdftitle   = {Blátivé děti: faktura za ###{Období}###},
     pdfauthor  = {Kateřina Jiřičková},
   }
}
\pagestyle{empty}
